...
describe("Vault.settings", function () {
  ...
  beforeEach(async () => {
    ...
    vaultDelegatePartOne = await deployContract("VaultDelegatePartOne", [])
    vaultDelegatePartTwo = await deployContract("VaultDelegatePartTwo", [])
    vaultDelegatePartThree = await deployContract("VaultDelegatePartThree", [])
    vault = await deployContract("Vault", [vaultDelegatePartOne.address, vaultDelegatePartTwo.address, vaultDelegatePartThree.address])
