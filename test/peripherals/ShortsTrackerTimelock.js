...
describe("ShortsTrackerTimelock", function () {
  ...
  beforeEach(async function () {
    ...
    vault = await deployContract("VaultTest", [vaultDelegatePartOne.address, vaultDelegatePartTwo.address, vaultDelegatePartThree.address])
