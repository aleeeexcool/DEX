...
async function main() {
  ...
  await sendTxn(zlp.setMinter(zlpManager.address, false), "zlp.setMinter")
  await sendTxn(usdg.removeVault(zlpManager.address), "usdg.removeVault")
  await sendTxn(vault.setManager(zlpManager.address, false), "vault.setManager")
}
