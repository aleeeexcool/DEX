...
async function main() {
  ...
  const zlpManager = await deployContract("ZlpManager", [vault.address, usdg.address, zlp.address, 15 * 60])
  ...
  await sendTxn(usdg.addVault(zlpManager.address), "usdg.addVault")
