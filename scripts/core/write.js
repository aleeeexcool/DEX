...
async function main() {
  ...
  // const zlpManager = await contractAt("ZlpManager", "0x14fB4767dc9E10F96faaF37Ad24DE3E498cC344B")
  // await sendTxn(zlpManager.setCooldownDuration(10 * 60), "zlpManager.setCooldownDuration")
  // const zke = await contractAt("ZKE", "0xfc5A1A6EB076a2C7aD06eD22C90d7E710E35ad0a", signer)
  ...
  // await sendTxn(zke.approve(stakedZkeTracker.address, 0), "zke.approve(stakedZkeTracker)")

  // const rewardRouter = await contractAt("RewardRouter", "0x67b789D48c926006F5132BFCe4e976F0A7A63d5D")
  // await sendTxn(rewardRouter.stakeEsZke(expandDecimals(1, 18)), "rewardRouter.stakeEsZke")
  ...
  // await sendTxn(zke.approve("0x62edc0692BD897D2295872a9FFCac5425011c661", 100, { nonce: 714 }), "zke.approve")
