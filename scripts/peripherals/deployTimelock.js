...
async function getArbValues() {
  ...
  return { vault, tokenManager, zlpManager, rewardRouter, positionRouter, positionManager, zke }
}
...
async function getAvaxValues() {
  ...
  const zke = { address: "0x62edc0692BD897D2295872a9FFCac5425011c661" }
...
async function main() {
  ...
  const { vault, tokenManager, zlpManager, rewardRouter, positionRouter, positionManager, zke } = await getValues()
  ...
  await sendTxn(deployedTimelock.signalApprove(zke.address, admin, "1000000000000000000"), "deployedTimelock.signalApprove")
}
