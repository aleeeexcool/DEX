...
const { DISTRIBUTION_LIST } = require("../../data/esZkeDistribution/distributionList1")
...
async function main() {
  ...
  await sendTxn(esZke.approve(batchSender.address, expandDecimals(100 * 1000, 18)), "esZke.approve")
