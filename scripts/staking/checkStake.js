...
async function main() {
  ...
  console.log("stakedZkeTracker.claimable", (await stakedZkeTracker.claimable(account)).toString())
  console.log("bonusZkeTracker.claimable", (await bonusZkeTracker.claimable(account)).toString())
  console.log("feeZkeTracker.claimable", (await feeZkeTracker.claimable(account)).toString())
}
