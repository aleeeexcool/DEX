...
contract Vault is ReentrancyGuard, IVault {
    ...
    address public delegatePartOne;
    address public delegatePartTwo;
    address public delegatePartThree;
    ...
    constructor(address _delegatePartOne, address _delegatePartTwo, address _delegatePartThree) public {
        gov = msg.sender;
        delegatePartOne = _delegatePartOne;
        delegatePartTwo = _delegatePartTwo;
        delegatePartThree = _delegatePartThree;
    }
    ...
    function setFees(
        ...
        (bool success, bytes memory result) = address(delegatePartOne).delegatecall(
            abi.encodeWithSignature(
                "setFees(uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,bool)",
                _taxBasisPoints,
        ...
        (uint256 errorCode) = abi.decode(result, (uint256));
        require(success && errorCode == NO_ERROR, errors[errorCode]);
    }
    ...
    function setTokenConfig(
        ...
        (bool success, bytes memory result) = address(delegatePartOne).delegatecall(
            abi.encodeWithSignature(
                "setTokenConfig(address,uint256,uint256,uint256,uint256,bool,bool)",
                _token,
                _tokenDecimals,
                _tokenWeight,
                _minProfitBps,
    ...
    function buyUSDG(address _token, address _receiver) external override nonReentrant returns (uint256) {
        (bool success, bytes memory result) = address(delegatePartTwo).delegatecall(
            abi.encodeWithSignature(
                "buyUSDG(address,address)",
                _token,
                _receiver
            )
        );
        (uint256 errorCode, uint256 mintAmount) = abi.decode(result, (uint256,uint256));
        require(success && errorCode == NO_ERROR, errors[errorCode]);
        return mintAmount;
    }
    ...
    function sellUSDG(address _token, address _receiver) external override nonReentrant returns (uint256) {
        (bool success, bytes memory result) = address(delegatePartTwo).delegatecall(
            abi.encodeWithSignature(
                "sellUSDG(address,address)",
                _token,
                _receiver
            )
        );
        (uint256 errorCode, uint256 burnAmount) = abi.decode(result, (uint256,uint256));
        require(success && errorCode == NO_ERROR, errors[errorCode]);
        return burnAmount;
    }
    ...
    function swap(address _tokenIn, address _tokenOut, address _receiver) external override nonReentrant returns (uint256) {
        ...
        (uint256 errorCode, uint256 amountOutAfterFees) = abi.decode(result, (uint256,uint256));
        require(success && errorCode == NO_ERROR, errors[errorCode]);
        return amountOutAfterFees;
    }

    function increasePosition(address _account, address _collateralToken, address _indexToken, uint256 _sizeDelta, bool _isLong) external override nonReentrant {
        (bool success, bytes memory result) = address(delegatePartThree).delegatecall(
            abi.encodeWithSignature(
                "increasePosition(address,address,address,uint256,bool)",
                _account,
                _collateralToken,
                _indexToken,
                _sizeDelta,
    ...
    function liquidatePosition(address _account, address _collateralToken, address _indexToken, bool _isLong, address _feeReceiver) external override nonReentrant {
        (bool success, /*bytes memory result*/) = address(delegatePartThree).delegatecall(
            abi.encodeWithSignature(
                "liquidatePosition(address,address,address,bool,address)",
                _account,
                _collateralToken,
                _indexToken,
                _isLong,
    ...
    function updateCumulativeFundingRate(address _collateralToken, address _indexToken) public {
        (bool success, /*bytes memory result*/) = address(delegatePartTwo).delegatecall(
            abi.encodeWithSignature(
                "updateCumulativeFundingRate(address,address)",
                _collateralToken,
                _indexToken
            )
        );
